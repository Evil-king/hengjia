 ...
 */
public class CodeGenerator_Hey {
    /**
     * JDBC配置
     */
...
//    private static final String PROJECT_PATH = "G:/IdeaProjects/hengjia-backend/hengjia-api-web"; // 项目基础路径
    private static final String PROJECT_PATH = "D:/baibei/code/hengjia-backend/hengjia-api-web"; // 项目基础路径
    private static final String TEMPLATE_PATH = "D:/baibei/code/hengjia-backend/hengjia-code-generator/src/main/resources/template";
    //    public static final String BASE_PACKAGE = "com.baibei.hengjia.api.modules.cash";//项目基础包名称，根据自己公司的项目修改
    public static final String BASE_PACKAGE = "com.baibei.hengjia.api.modules.settlement";//项目基础包名称，根据自己公司的项目修改
    ...
    private static final String AUTHOR = "会跳舞的机器人";//@author
    ...
    public static void main(String[] args) {
        genCodeByCustomModelName("tbl_customer", "Customer");
//        genCodeByCustomModelName("tbl_set_clean_help", "CleanHelp");
//        genCodeByCustomModelName("tbl_tra_trade_whitelist", "TradeWhiteList");
    }
