 ...
 */
public class CodeGenerator_Longer {
    /**
     * JDBC配置
     */
     ...
     * 项目路径相关
     */
    private static final String PROJECT_PATH = "F:/hengjia-backend/hengjia-api-web"; // 项目基础路径
    private static final String TEMPLATE_PATH = "F:/hengjia-backend/hengjia-code-generator/src/main/resources/template"; // 代码模板路径
    public static final String BASE_PACKAGE = "com.baibei.hengjia.api.modules.match";//项目基础包名称，根据自己公司的项目修改
    ...
    public static void main(String[] args) {
        genCodeByCustomModelName("tbl_ph_offset_deliveryticket","OffsetDeliveryticket");
        genCodeByCustomModelName("tbl_ph_offset_deliveryticket_record","OffsetDeliveryticketRecord");
