...
//    private static final String PROJECT_PATH = "G:/IdeaProjects/hengjia-backend/hengjia-api-web"; // 项目基础路径
    private static final String PROJECT_PATH = "D:/hengjia-placement"; // 项目基础路径
    private static final String TEMPLATE_PATH = "D:/hengjia/hengjia-backend/hengjia-code-generator/src/main/resources/template"; // 代码模板路径
//    public static final String BASE_PACKAGE = "com.baibei.hengjia.api.modules.cash";//项目基础包名称，根据自己公司的项目修改
    public static final String BASE_PACKAGE = "com.baibei.hengjia.placement";//项目基础包名称，根据自己公司的项目修改
    ...
    private static final String AUTHOR = "hyc";//@author
...
//        genCodeByCustomModelName("tbl_tra_order_deposit", "OrderDeposit");
        genCodeByCustomModelName("tbl_tra_delivery","Delivery");
