...
public class SigningRecord {
    ...
    /**
     * 会员证件类型(P：固定1 身份证 E：989：统一社会信用代码
            995：组织机构代码证)
     */
    @Column(name = "id_type")
    ...
    /**
     * 账号性质(1、出金账号 2、入金账号 3、出金账号&入金账号)
     */
    ...
    /**
     * 获取会员证件类型(P：固定1 身份证 E：989：统一社会信用代码
            995：组织机构代码证)
     *
     * @return id_type - 会员证件类型(P：固定1 身份证 E：989：统一社会信用代码
            995：组织机构代码证)
     */
    ...
    /**
     * 设置会员证件类型(P：固定1 身份证 E：989：统一社会信用代码
            995：组织机构代码证)
     *
     * @param idType 会员证件类型(P：固定1 身份证 E：989：统一社会信用代码
            995：组织机构代码证)
     */
    ...
    /**
     * 获取账号性质(1、出金账号 2、入金账号 3、出金账号&入金账号)
     *
     * @return acct_flag - 账号性质(1、出金账号 2、入金账号 3、出金账号&入金账号)
     */
    ...
    /**
     * 设置账号性质(1、出金账号 2、入金账号 3、出金账号&入金账号)
     *
     * @param acctFlag 账号性质(1、出金账号 2、入金账号 3、出金账号&入金账号)
     */
