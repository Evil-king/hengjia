...
@Table(name = "tbl_record_coupon_thaw")
public class RecordCouponThaw {
    /**
     * 主键ID
     */
    @Id
    ...
    /**
     * 获取交易类型（111：获得额度，112：消耗额度）
     *
     * @return trade_type - 交易类型（111：获得额度，112：消耗额度）
     */
    ...
    /**
     * 设置交易类型（111：获得额度，112：消耗额度）
     *
     * @param tradeType 交易类型（111：获得额度，112：消耗额度）
     */
     ...
     * 获取变动后冻结金额余额
     *
     * @return thaw_balance - 变动后冻结金额余额
     */
    public BigDecimal getThawBalance() {
        return thawBalance;
    }
     ...
     * 设置变动后冻结金额余额
     *
     * @param thawBalance 变动后冻结金额余额
     */
    public void setThawBalance(BigDecimal thawBalance) {
