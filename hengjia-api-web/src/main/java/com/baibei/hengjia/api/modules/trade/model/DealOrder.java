...
public class DealOrder {
    ...
    @Column(name = "integral_return_flag")
    private String integralReturnFlag;

    @Column(name = "hongmu_fund")
    private BigDecimal hongmuFund;

    public BigDecimal getHongmuFund() {
        return hongmuFund;
    }

    public void setHongmuFund(BigDecimal hongmuFund) {
        this.hongmuFund = hongmuFund;
    }

    public String getIntegralReturnFlag() {
        return integralReturnFlag;
    }

    public void setIntegralReturnFlag(String integralReturnFlag) {
        this.integralReturnFlag = integralReturnFlag;
    }
