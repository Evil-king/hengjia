...
public class CleanData {
     ...
     */
    @Column(name = "add_tran_amount")
    private BigDecimal addTranAmount;

    /**
     * 当天成交的总货款（作为买方）（减少银行可用余额）
     */
    @Column(name = "cut_tran_amount")
     ...
     *
     * @return add_tran_amount - 当天成交的总货款（作为卖方）（增加银行可用余额）
     */
     ...
     *
     * @return cut_tran_amount - 当天成交的总货款（作为买方）（减少银行可用余额）
     */
