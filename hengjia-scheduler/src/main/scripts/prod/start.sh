...
nohup java $JAVA_OPT -Dapp.id=hengjia-scheduler -Denv=pro -Dapollo.cluster=default -Dapollo.meta=http://192.168.11.231:8080 -classpath $CONFIG_DIR:$LIB_JARS $MAIN_CLASS >> /logs/$SERVICE_NAME/std-out.log 2>&1 &